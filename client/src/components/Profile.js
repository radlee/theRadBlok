...
function Profile() {
  ...
  <div class="container max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
    ...
    <div class="">
      <div class="px-7 mb-8">
        <h2 class="text-3xl font-bold text-green-800 dark:text-gray-300">{currentUser.name}</h2>
        <p class="text-gray-400 mt-2 dark:text-gray-400">{currentUser.createdAt}</p>
        <div
